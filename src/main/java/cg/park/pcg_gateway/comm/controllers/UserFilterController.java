...
@Component
public class UserFilterController extends AbstractGatewayFilterFactory<UserFilterController.Config> {
    private static final Logger log = LogManager.getLogger(UserFilterController.class);
