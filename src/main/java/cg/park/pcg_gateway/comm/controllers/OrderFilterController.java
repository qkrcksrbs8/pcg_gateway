...
@Component
public class OrderFilterController extends AbstractGatewayFilterFactory<OrderFilterController.Config> {
    private static final Logger log = LogManager.getLogger(OrderFilterController.class);
